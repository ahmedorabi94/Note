package com.example.telekotlin.ui.signatureview;
...
import com.example.telekotlin.ui.signatureview.model.Point;
...
public class SignatureView extends View {
    ...
    public void setBitmap(Bitmap bitmap) {
        if (bitmap != null) {
            bmp = bitmap;
            canvasBmp = new Canvas(bitmap.copy(Bitmap.Config.ARGB_8888, true));
            postInvalidate();
        }
    }
